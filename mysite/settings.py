...
SECRET_KEY = 'i0qb6u2g!331zsyps!$2dydayv#8fg6by9r36bt(kb!$d1bs-7'
...
TEMPLATES = [
    {
        ...
        # 'DIRS': [],
        'DIRS': [os.path.join(BASE_DIR, 'templates')],  # specify template
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATIC_ROOT =  os.path.join(BASE_DIR, "static_root")  # todo
